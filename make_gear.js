...
function getCmd(dName, fName) {
	...
	//rCmd.push(`npx designix-cli -d=desi82/${desiName} -o=refs/${dName} --outFileName=px_${fName}.json write json_param`);
	rCmd.push(`npx designix-cli -d=desi82/${desiName} -p=refs/${dName}/px_${fName}.json -o=refs/${dName} --outFileName=${fName}.scad write scad_3d_openscad`);
...
console.log('make_gear.js says Hello!');
await mhcli(process.argv);
console.log('make_gear.js says Bye!');
